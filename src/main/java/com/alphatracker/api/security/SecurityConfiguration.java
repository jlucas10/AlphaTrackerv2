...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            // backend, we want it completely stateless. Every single request must stand on its own 
            ...
            // built-in UsernamePasswordAuthenticationFilter. This ensures we catch the token, 
            // validate it, and authenticate the user before Spring tries to process standard form login.
